...
*/
	...
	["Лемма о представлении простой случайной величины",["если","$(\\Omega, \\mathcal{F}, P)$","--","вероятностное","простнанство",",","$X$","--","случайная","величина","на","$(\\Omega, \\mathcal{F}, P)$",",","$X$","--","простая","функция","(","из","интеграла","Лебега","овитма",")",",","тогда","$(\\exists \\{ x_i \\}_{i = 1}^n \\subset \\mathbb{R} : x_i \\neq 0)$","$(\\forall \\omega \\in \\Omega)$","$P(\\omega)$","$=$","$\\sum_{i = 1}^n$","$x_i P(\\{ \\omega \\in \\Omega : X(\\omega) = x_i \\})$","(","в","овитме","было","не","так",",","приходится","конвертировать",",","в","дальнейшем","будем","обозначать","$P(\\{ \\omega \\in \\Omega : X(\\omega) = y \\})$","как","$P(X = y)$",")"]],
	...
	["Доказательство",["Математическое","ожидание","определяется","как","интеграл","Лебега",",","потому","повторим","шаги","из","определения","интеграла","Лебега","&br&","1",")","докажем",",","если","$X$","и","$Y$","--","простые","функции","&br&","1.1",")","$X$","--","простая",",","т.е.","&br&","$(\\exists {\\{ E_i \\}}_{i = 1}^n : E_i \\cap E_j = \\varnothing)$","$(\\exists x_1, \\ldots, x_n \\in \\mathbb{R} : x_i \\neq 0)$","$(\\forall \\omega \\in \\Omega)$","$X(\\omega)$","$=$","$\\sum_{i = 1}^n$","$x_i$","$\\mathbb{I}(\\omega \\in E_i)$","(","по","определению","простой","функции",",","из","овитма",")","&br&","1.2.)","знаем","интеграл","Лебега","для","$X$",",","т.к.","она","простая",":","&br&","$\\int_\\Omega$","$X(\\omega)$","$dP(\\omega)$","$=$","$\\sum_{i = 1}^n$","$x_i$","$\\mu_{P}(E_i)$","&br&","$(\\exists {\\{ H_i \\}}_{i = 1}^k : H_i \\cap H_j = \\varnothing)$","$(\\exists y_1, \\ldots, y_k \\in \\mathbb{R} : y_i \\neq 0)$","$(\\forall \\omega \\in \\Omega)$","$Y(\\omega)$","$=$","$\\sum_{i = 1}^k$","$y_i$","$\\mathbb{I}(\\omega \\in H_i)$","(","по","определению","простой","функции",")","&br&"]],
