...
*/
	...
	["Критерий измеримости отображения",["если","$(\\Omega, \\mathcal{F}, P)$","--","вероятностное","пространство",",","$(E, \\xi)$","--","измеримое","пространство",",","$\\mathcal{M} \\subset \\xi$",",","$\\sigma(\\mathcal{M})$","$=$","$\\xi$",",","$X: \\Omega \\to E$",",","тогда","$X$","измеримо","тогда","и","только","тогда",",","когда","$(\\forall B \\in \\mathcal{M})$","$X^{-1}(B) \\in \\mathcal{F}$","(","т.е.","достаточно","проверять","на","порождающем","множестве",",","а","не","на","всём",")"]],
