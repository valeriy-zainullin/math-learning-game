...
*/
	...
	["Математическое ожидание случайной величины",["пусть","$(\\Omega, \\mathcal{F}, P)$","--","вероятностное","пространство",",","$X$","--","случайная","величина","на","$(\\Omega, \\mathcal{F}, P)$",";","математическим","ожиданием","$X$","называется","интеграл","Лебега","от","$X$","по","мере","$P$",":","&br&","$\\mathbf{E}(\\xi)$","$=$","$\\int_{\\Omega}$","$X(\\omega)$","$dP(\\omega)$","$=$","$\\int_{\\Omega}$","$X(\\omega)$","$P(d\\omega)$","$=$","$\\int_{\\Omega}$","$X$","$dP$","(","последнее","--","обозначение?",")","(","на","овитме","определяли","меру","Лебега","по","мере","и","интеграл","Лебега","по","мере",")"]],
