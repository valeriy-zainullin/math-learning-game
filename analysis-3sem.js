...
analysis_3sem = [
	...
	[
		...
		["если", "мера", "$E$", "конечна", ",", "$f$", "измерима", "и", "ограничена",
			...
			"$\\left| \\int\\limits_E f(x) d\\mu(x) - S(Q, f, \\{ t_i \\}) \\right|$"
		]
	],
	[
	...
	[
		...
		["если", "мера", "$E$", "конечна", ",", "$f_1$", "и", "$f_2$", "суммируемы", "на",
			"на", "$E$", ",", "$c_1, c_2 \\mathbb{R}$", "тогда",
			"$с_1 f_1 + c_2 f_2$", "тоже", "суммируема", "на", "$E$", "и",
			"$\\int\\limits_E (c_1 f_1(x) + c_2 f_2(x)) d\\mu(x) = c_1 \\int\\limits_E f_1(x) + c_2 \\int\\limits_E f_2(x)$"
		]
	],*/
	[
